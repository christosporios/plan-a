...
const HOMEPAGE = {
  ...
  description: 'Η Αθήνα δεν είναι χαμένη υπόθεση. Είκοσι συγκεκριμένες προτάσεις για την πόλη — με αισθητό όφελος για τους περισσότερους, μικρό κόστος εφαρμογής και χωρίς εκτεταμένες ρυθμιστικές αλλαγές.',
  image: '/og-cover.jpg',
  path: '/',
};
